...
st.markdown(
    """
<style>
.main .block-container{max-width:1180px;padding-top:.7rem;padding-bottom:4rem}.top{border:1px solid #dbeafe;border-radius:1.25rem;background:rgba(255,255,255,.96);box-shadow:0 12px 30px rgba(15,23,42,.06);padding:.9rem 1rem;margin:.3rem 0 1rem;display:flex;justify-content:space-between;gap:1rem;align-items:center}.brand{font-size:1.18rem;font-weight:980;color:#0f172a}.brand small{display:block;color:#64748b;font-size:.82rem;font-weight:850}.nav{display:flex;gap:.5rem;flex-wrap:wrap}.pill{display:inline-block;border-radius:999px;padding:.28rem .64rem;font-size:.8rem;font-weight:900;border:1px solid #e2e8f0;background:#f8fafc;color:#475569;margin:.1rem .16rem}.hot{background:linear-gradient(90deg,#4f46e5,#06b6d4);border:none;color:white}.green{background:#dcfce7;color:#166534;border-color:#bbf7d0}.orange{background:#ffedd5;color:#9a3412;border-color:#fed7aa}.blue{background:#dbeafe;color:#1e40af;border-color:#bfdbfe}.purple{background:#ede9fe;color:#5b21b6;border-color:#ddd6fe}.hero{border:1px solid #c7d2fe;border-radius:1.5rem;background:radial-gradient(circle at right,#ecfeff,#eef2ff 45%,#fff);padding:2rem;margin:.8rem 0 1rem}.hero h1{font-size:2.45rem;line-height:1.08;margin:.25rem 0;color:#0f172a}.hero h1 span{background:linear-gradient(90deg,#4f46e5,#06b6d4);-webkit-background-clip:text;color:transparent}.hero p{max-width:900px;color:#475569;line-height:1.75}.section{font-size:1.45rem;font-weight:950;margin:1.2rem 0 .45rem;color:#0f172a}.grid2{display:grid;grid-template-columns:1fr 1fr;gap:1rem}.grid3{display:grid;grid-template-columns:repeat(3,1fr);gap:.85rem}.grid4{display:grid;grid-template-columns:repeat(4,1fr);gap:.75rem}.card{border:1px solid #e2e8f0;border-radius:1.1rem;background:white;padding:1rem;box-shadow:0 8px 20px rgba(15,23,42,.04)}.card h3{margin:.1rem 0 .45rem;color:#111827}.card p{color:#64748b;line-height:1.58}.metric{font-size:2rem;font-weight:980;color:#0f172a}.panel{border:1px solid #dbeafe;border-radius:1.2rem;background:linear-gradient(135deg,#fff,#f8fafc);padding:1.1rem;margin:.9rem 0}.panel h2{margin:.15rem 0;color:#0f172a}.quote{white-space:pre-wrap;background:#0f172a;color:#e2e8f0;border-radius:1rem;padding:1rem;line-height:1.65}.progress{height:.65rem;border-radius:999px;background:#e2e8f0;overflow:hidden;margin-top:.45rem}.bar{height:100%;background:linear-gradient(90deg,#4f46e5,#06b6d4)}.ok{border:1px solid #bbf7d0;background:#f0fdf4;color:#166534;border-radius:1rem;padding:1rem}.warn{border:1px solid #fed7aa;background:#fff7ed;color:#7c2d12;border-radius:1rem;padding:1rem}.mini{font-size:.85rem;color:#64748b;line-height:1.55}.decision{border-left:5px solid #6366f1}.task-rail,.list-panel,.funnel-panel{border:1px solid #e0e7ff;border-radius:1.1rem;background:#f8fafc;padding:.85rem}.task-mini,.list-item{border:1px solid #e2e8f0;border-radius:1rem;background:white;padding:.85rem;margin:.55rem 0}.task-mini.active,.list-item.active{border-color:#6366f1;box-shadow:0 8px 20px rgba(99,102,241,.12)}.editor,.detail,.plan-card{border:1px solid #c7d2fe;border-radius:1.2rem;background:white;padding:1rem;box-shadow:0 10px 24px rgba(79,70,229,.06)}.history{border:1px solid #e2e8f0;border-radius:1rem;background:white;padding:.9rem;max-height:260px;overflow:auto}.history-item{border-bottom:1px solid #f1f5f9;padding:.55rem 0;color:#475569}.history-item:last-child{border-bottom:none}.toolbar{display:grid;grid-template-columns:repeat(3,1fr);gap:.5rem}.result-strip{display:grid;grid-template-columns:repeat(4,1fr);gap:.7rem;margin:1rem 0}.result-strip div{border:1px solid #dbeafe;border-radius:1rem;background:white;padding:1rem}.flow-step{border:1px solid #e0e7ff;border-radius:1rem;background:#fff;padding:1rem}.faq{border:1px solid #e2e8f0;border-radius:1rem;background:#fff;padding:1rem;margin:.55rem 0}.login-box{position:sticky;top:1rem}.hero-actions{display:flex;gap:.5rem;flex-wrap:wrap;margin:.75rem 0}.dash-main{display:grid;grid-template-columns:1.25fr .75fr;gap:1rem;align-items:start}.next-action{border:1px solid #c7d2fe;border-radius:1.2rem;background:linear-gradient(135deg,#fff,#eef2ff);padding:1rem}.dash-list{display:grid;gap:.75rem}.task-layout,.portfolio-layout,.consult-layout{display:grid;grid-template-columns:.9fr 1.35fr .95fr;gap:1rem;align-items:start}.evidence-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:.7rem}.evidence{border:1px dashed #c7d2fe;border-radius:1rem;background:#f8fafc;padding:.85rem}.share-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:.55rem}.share-grid div{border:1px solid #e2e8f0;border-radius:1rem;background:white;padding:.75rem}.score-card{border:1px solid #c7d2fe;border-radius:1.2rem;background:linear-gradient(135deg,#eef2ff,#fff);padding:1rem;text-align:center}.score-card b{font-size:2.2rem;color:#3730a3}.step-line{border-left:4px solid #6366f1;background:#fff;border-radius:.85rem;padding:.75rem .9rem;margin:.6rem 0}.lead-card{border:1px solid #c7d2fe;border-radius:1.2rem;background:linear-gradient(135deg,#fff,#eef2ff);padding:1rem}.queue-card{border:1px solid #e0e7ff;border-radius:1rem;background:white;padding:1rem;margin:.7rem 0}@media(max-width:900px){.top{display:block}.grid2,.grid3,.grid4,.dash-main,.task-layout,.portfolio-layout,.consult-layout,.toolbar,.result-strip,.evidence-grid,.share-grid{grid-template-columns:1fr}.hero h1{font-size:2rem}.hero-actions{display:block}}
</style>
""",
...
STATUS_CLASS = {
    "访客": "", "学员": "blue", "Founder": "hot", "未开始": "", "进行中": "purple", "AI已反馈": "orange", "待Agent点评": "blue", "Agent已点评": "green", "已完成": "green", "今日主任务": "purple", "等待点评": "blue", "未解锁": "", "可展示": "green", "修改中": "orange", "待点评": "blue", "新线索": "blue", "已联系": "purple", "已预约": "orange", "已成交": "green", "推荐": "green",
}
...
def recommend_package(identity: str, goal: str) -> tuple[str, str, list[str], list[str]]:
    if "企业" in identity or "企业" in goal:
        return "企业训练版", "适合部门新人训练、AI任务标准化和内部培训产品化。", ["梳理部门高频任务", "生成训练任务卡", "员工提交练习", "Agent初评", "主管看异常与日报"], ["部门高频任务地图", "员工练习包", "评分标准", "Founder/主管日报"]
    if "自由职业" in identity or "小微老板" in identity or "自由职业" in goal or "接单" in goal:
        return "自由职业版", "适合把技能包装成服务、样品案例、报价表达和客户交付物。", ["选择可售卖技能", "定义目标客户", "制作样品案例", "Agent打磨表达", "形成服务包"], ["服务方向定位", "样品案例", "报价表达", "客户沟通话术"]
    return "个人成长版", "适合职场新人、在岗提升、升职准备、转岗跳槽和作品集建设。", ["明确成长目标", "完成5天任务", "获得Agent反馈", "沉淀作品集", "生成30天行动计划"], ["5天成长路线图", "测试/业务分析作品", "Agent点评记录", "30天行动计划"]
...
""", unsafe_allow_html=True)
    ...
    with left:
        ...
        if not pending and not leads:
            st.info("暂无待处理事项。可以切换到学员Demo提交任务或生成咨询摘要。")
    with right:
...
def consult_page() -> None:
    ...
    with right:
        ...
        with st.form("consult_form_v475"):
...
def founder_queue() -> None:
    ...
    if not st.session_state.submitted and not st.session_state.consult_summary:
        ...
        return
    if st.session_state.submitted:
        st.markdown("<div class='queue-card decision'><h3>待点评：登录测试作品</h3><p>学员已提交草稿，等待 Founder/Agent 决策。</p></div>", unsafe_allow_html=True)
    if st.session_state.consult_summary:
        st.markdown(f"<div class='queue-card decision'><h3>咨询线索 {chip(st.session_state.lead_status)}</h3><p>{st.session_state.consult_summary.replace(chr(10), '<br>')}</p></div>", unsafe_allow_html=True)
        c1, c2, c3 = st.columns(3)
...
st.caption("AI Skill Growth OS · Role-based Dashboards · v4.7.5")
