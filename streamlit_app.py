...
@media (max-width:960px){.site-shell{position:relative;top:0}.platform-nav{border-radius:1rem;align-items:flex-start;flex-direction:column}.nav-row{grid-template-columns:1fr}.nav-help{white-space:normal}.hero-grid{grid-template-columns:1fr}.hero-title{font-size:2.25rem}.visual{min-height:450px}.card-grid,.pain-grid,.program-grid,.track-grid,.before-after,.platform-strip{grid-template-columns:1fr}.flow{grid-template-columns:repeat(2,1fr)}.artifact-wall{grid-template-columns:repeat(2,1fr)}.statbar{grid-template-columns:repeat(2,1fr)}.nav-actions span{margin:.12rem .1rem}.journey{grid-template-columns:repeat(5,1fr)}.mini-grid{grid-template-columns:1fr}}
</style>
""",
  ...
  <div class='hero-grid'>
    ...
    <div class='visual'>
      ...
      <div class='illustration-card'>
        ...
        <div class='ai-window'>
          <div class='ai-window-top'><b>AI Skill Coach</b><div class='dots'><span></span><span></span><span></span></div></div>
          <div class='prompt'><strong>今日任务：</strong>把“想学 PPT 汇报”拆成 3 个练习任务，并生成可提交作品标准。</div>
        </div>
        <div class='mini-grid'>
          <div class='mini'>📦 作品集<small>能展示，不空谈</small></div>
          <div class='mini'>💼 服务包<small>能报价，能交付</small></div>
          <div class='mini'>🎤 表达稿<small>升职 / 面试 / 接单</small></div>
          <div class='mini'>✅ 反馈记录<small>AI 纠错 + 人工点评</small></div>
        </div>
      </div>
      <div class='progress-card'><div class='progress-title'><span>Skill Growth Progress</span><span>72%</span></div><div class='bar'><span></span></div></div>
    </div>
  </div>
</div>
""",
...
<div class='platform-strip'>
  <div class='metric-card'><b>4</b><span>主路径：新人、升职、跳槽、自由职业</span></div>
  <div class='metric-card'><b>6</b><span>训练闭环：目标、学习、任务、反馈、作品、价值</span></div>
  <div class='metric-card'><b>3+</b><span>每期沉淀可展示作品</span></div>
  <div class='metric-card'><b>1</b><span>个人技能增长与变现路径</span></div>
</div>
""",
        unsafe_allow_html=True,
    )
...
def main():
    ...
    if page == "home":
        ...
        render_faq(lang)
    st.caption("AI Skill Growth Platform · hero visual v1.6")
