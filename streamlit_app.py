...
st.markdown(
    """
<style>
:root{--ink:#0f172a;--muted:#64748b;--brand:#4f46e5;--brand2:#06b6d4;--green:#22c55e;--orange:#f97316;--line:#e2e8f0}
.main .block-container{max-width:1180px;padding-top:.65rem;padding-bottom:3rem}[data-testid="stSidebar"],[data-testid="collapsedControl"]{display:none}
...
def render_top_nav(lang: str):
    st.markdown("""
<div class='site-shell'><div class='platform-nav'>
...
<div class='eyebrow'>AI Skill Growth Platform</div><h1 class='hero-title'>{hero_title}</h1>
...
</div><div class='visual'><div class='orb orb-a'></div><div class='orb orb-b'></div><div class='orb orb-c'></div><div class='illustration-card'>
<div class='coach-header'><div class='coach-title'><div class='coach-avatar'>AI</div><div>Skill Growth Dashboard</div></div><div class='status'>Live Coach</div></div>
<div class='journey'><div><b>01</b><span>定目标</span></div><div><b>02</b><span>学技能</span></div><div><b>03</b><span>做任务</span></div><div><b>04</b><span>出作品</span></div><div><b>05</b><span>变价值</span></div></div>
<div class='ai-window'><div class='ai-window-top'><b>AI Skill Coach</b><div class='dots'><span></span><span></span><span></span></div></div><div class='prompt'><strong>今日任务：</strong>把“想学 PPT 汇报”拆成 3 个练习任务，并生成可提交作品标准。</div></div>
<div class='mini-grid'><div class='mini'>📦 作品集<small>能展示，不空谈</small></div><div class='mini'>💼 服务包<small>能报价，能交付</small></div><div class='mini'>🎤 表达稿<small>升职 / 面试 / 接单</small></div><div class='mini'>✅ 反馈记录<small>AI 纠错 + 人工点评</small></div></div>
</div><div class='progress-card'><div class='progress-title'><span>Skill Growth Progress</span><span>72%</span></div><div class='bar'><span></span></div></div></div></div></div>
""", unsafe_allow_html=True)

    st.markdown("""
<div class='platform-strip'><div class='metric-card'><b>4</b><span>主路径：新人、升职、跳槽、自由职业</span></div><div class='metric-card'><b>6</b><span>训练闭环：目标、学习、任务、反馈、作品、价值</span></div><div class='metric-card'><b>3+</b><span>每期沉淀可展示作品</span></div><div class='metric-card'><b>1</b><span>个人技能增长与变现路径</span></div></div>
""", unsafe_allow_html=True)
    ...
    st.markdown("""
<div class='before-after'><div class='ba before'><h4>普通学习方式</h4><ul><li>看很多教程，但没有真实任务</li><li>不知道自己错在哪里</li><li>学完没有作品，无法证明能力</li><li>自由职业不会包装服务和报价</li></ul></div><div class='ba after'><h4>AI 技能成长方式</h4><ul><li>先定技能目标，再拆成任务</li><li>AI 做第一轮纠错，老师做关键点评</li><li>每个阶段都有可展示作品</li><li>把技能变成服务包、报价和交付 SOP</li></ul></div></div>
""", unsafe_allow_html=True)
...
<div class='trust-band'>
  <div class='trust-box'><b>为什么这个产品更容易被购买？</b><p>它不是卖“AI 很厉害”，而是卖明确结果：学会一个技能、完成真实任务、获得 AI 反馈、形成作品集、用于升职/转岗/跳槽/接单。</p></div>
  <div class='risk-box'><b>合规边界</b><br>不承诺就业、不承诺涨薪、不承诺接单收入、不做官方证书。平台只交付训练过程、作品成果、服务包和表达能力。</div>
</div>
""", unsafe_allow_html=True)

    st.markdown("""
<div class='bottom-cta'><h3>先用 2 小时，找到你的下一个技能增长点。</h3><p>选择一个技能目标，现场完成一个微型任务和 AI 学习路径。后续可以进入 5 天技能成长营、自由职业技能变现营或企业内训。</p><div class='cta-row'><span class='btn btn-primary'>🚀 预约体验课</span><span class='btn btn-secondary'>📩 咨询课程方案</span></div></div>
""", unsafe_allow_html=True)
...
def main():
    ...
    st.caption("AI Skill Growth Platform · product conversion v1.7")
