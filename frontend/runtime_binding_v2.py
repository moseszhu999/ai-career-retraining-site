...
from frontend import business_pages, executive_pages, operation_state, pages
...
def bind_production_master_data() -> None:
    ...
    learners = prod.learners()
    exercises = prod.exercises()
    for module in (pages, business_pages, executive_pages):
        module.CLIENTS = clients
        module.COHORTS = cohorts
    pages.LEARNERS = learners
    business_pages.LEARNERS = learners
