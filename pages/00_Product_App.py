...
def render_nav() -> str:
    st.markdown(
        """
<div class='app-nav'>
  <div class='brand'><div class='logo'>AI</div><div>AI Skill Growth<small>一人公司 · Agent OS · v4.3.5</small></div></div>
...
def render_home() -> None:
    ...
    st.markdown(
        f"""
<div class='hero'>
<span class='eyebrow'>STUDENT PRODUCT HOME</span>
...
def render_consult() -> None:
    ...
    with st.form("consult_form_v435"):
...
st.caption("AI Skill Growth Platform · Product Navigation Shell · v4.3.5")
